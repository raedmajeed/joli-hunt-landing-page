    ...
    <section className="py-16 lg:py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center mb-8 animate-fade-in-up">
          <div className="inline-flex items-center gap-2 bg-[#F4B400] bg-opacity-10 px-6 py-3 rounded-full">
            <Users className="w-5 h-5 text-[#F4B400]" />
            <span className="font-bold text-[#F4B400]">Join 1,000+ job seekers organizing their search</span>
          </div>
        </div>
        ...
        <div className="text-center mb-12 animate-fade-in-up delay-100">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-[#1C1C1C] mb-4">
            See JoliHunt in <span className="text-[#F4B400]">Action</span>
          </h2>
        ...
        <div className="relative animate-fade-in-up delay-200">
          ...
          {/* Floating Elements */}
          <div className="absolute -top-6 -left-6 w-24 h-24 bg-[#F4B400] opacity-10 rounded-full blur-2xl animate-pulse"></div>
          <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#F4B400] opacity-10 rounded-full blur-3xl animate-pulse delay-700"></div>
        </div>
      </div>
    </section>
  );
